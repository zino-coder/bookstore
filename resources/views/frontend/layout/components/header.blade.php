        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="demo1.html" class="logo">
                    <img src="{{ asset('riode/images/logo.png') }}" alt="logo" width="153" height="44" />
                </a>
                <!-- End Logo -->
            ...
            <div class="header-right">
                        ...
                        <div class="products scrollable">
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('riode/images/wishlist/product-1.jpg') }}" width="100" height="100"
                                             alt="product" />
                                    </a>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('riode/images/wishlist/product-2.jpg') }}" width="100" height="100"
                                             alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('riode/images/wishlist/product-3.jpg') }}" width="100" height="100"
                                             alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                ...
                <span class="divider"></span>
                @include('frontend.layout.components.cart-header')
            </div>
        </div>
    </div>
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <figure>
                                            <img src="{{ asset('riode/images/menu/banner-1.jpg') }}" alt="Menu banner" width="221"
                                                 height="330" />
                                        </figure>
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <figure>
                                            <img src="{{ asset('riode/images/menu/banner-2.jpg') }}" alt="Menu banner" width="221"
                                                 height="330" />
                                        </figure>
