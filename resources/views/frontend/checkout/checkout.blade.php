...
@section('content')
    <div class="page-content pt-7 pb-10 mb-10">
        ...
        <div class="container mt-7">
            ...
            <form action="{{ route('checkout.place-order') }}" class="form" method="POST">
                @csrf
                <div class="row">
                                ...
                                <table class="order-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-name">{{ $item['name'] }}<span
                                                class="product-quantity">×&nbsp;{{ $item['amount'] }}</span></td>
                                    ...
                                    <tr class="summary-total">
                                        ...
                                        <td class=" pt-0 pb-0">
                                            <p class="summary-total-price ls-s text-primary">${{ number_format(cart()->getTotal()) }}</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
