                    ...
                    <table class="shop-table cart-table">
                        ...
                        <tr>
                            ...
                            <td class="product-price">
                                <span class="amount">${{ number_format($item['amount'] * $item['price']) }}</span>
                            </td>
                        ...
                        <div class="summary mb-4">
                            ...
                            <table class="shipping">
                                <tr class="summary-subtotal">
                                    ...
                                    <td>
                                        <p class="summary-subtotal-price">${{ number_format(cart()->getTotal()) }}</p>
                                    </td>
                                </tr>
                            ...
                            <a href="{{ route('checkout.index') }}" class="btn btn-dark btn-rounded btn-checkout">Proceed to
                                checkout</a>
                        </div>
                    </div>
                </aside>
