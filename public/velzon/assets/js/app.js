!function () {
    ...
    function p(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "velzon/assets/images/flags/us.svg" : "sp" == e ? document.getElementById("header-lang-img").src = "velzon/assets/images/flags/spain.svg" : "gr" == e ? document.getElementById("header-lang-img").src = "velzon/assets/images/flags/germany.svg" : "it" == e ? document.getElementById("header-lang-img").src = "velzon/assets/images/flags/italy.svg" : "ru" == e ? document.getElementById("header-lang-img").src = "velzon/assets/images/flags/russia.svg" : "ch" == e ? document.getElementById("header-lang-img").src = "velzon/assets/images/flags/china.svg" : "fr" == e && (document.getElementById("header-lang-img").src = "velzon/assets/images/flags/french.svg"), localStorage.setItem("language", e), null == (y = localStorage.getItem("language")) && p(b), (e = new XMLHttpRequest).open("GET", "velzon/assets/lang/" + y + ".json"), e.onreadystatechange = function () {
            var a;
    ...
    function f() {
        var o, e = document.documentElement.getAttribute("data-layout"), t = sessionStorage.getItem("defaultAttribute"),
            t = JSON.parse(t);
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu").innerHTML = u, (o = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="velzon/assets/images/logo-sm.png" alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (e) {
